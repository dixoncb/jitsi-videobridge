        ...
        ColibriWebSocket.EventHandler
{
    ...
    public BridgeChannelMessage pinnedEndpoints(PinnedEndpointsMessage message)
    {
        ...
        setSenderVideoSetupMap(
                videoConstraintsCompatibility.computeVideoSetupMap());
     ...
     * {@link #endpoint}.
     */
    public void setSenderVideoSetupMap(
            Map<String, VideoSetup> videoSetupMap)
    {
        ...
        endpoint.setSenderVideoSetupMap(
                ImmutableMap.copyOf(videoSetupMap));
    }
